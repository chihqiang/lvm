...
/// Config constant function tests
#[test]
...
/// set_alias / get_alias / list_alias_names / remove_alias integration tests
#[test]
#[serial]
fn test_alias_crud() {
    let dir = tempfile::tempdir().unwrap();
...
/// set_default_version / get_default_version tests
#[test]
#[serial]
...
/// write_lvmrc / read_lvmrc_version tests
#[test]
#[serial]
